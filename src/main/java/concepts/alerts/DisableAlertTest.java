...
public class DisableAlertTest {
	...
	public void testDisableAlert() {
		...
		// Disable alerts by overriding the window.alert function with an empty function
		...
		try {
			// Wait until an alert is present or timeout occurs
			...
			// Handle the case when no alert is present within the specified timeout
			System.out.println("No Alert is present in the given wait time");
		}
