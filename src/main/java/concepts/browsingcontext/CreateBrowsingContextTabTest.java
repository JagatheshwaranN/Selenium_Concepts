...
public class CreateBrowsingContextTabTest {
    ...
    @Test(priority = 1)
    public void testCreateBrowsingContextTab() {
        // Create a BrowsingContext object with the driver and specify WindowType as TAB
