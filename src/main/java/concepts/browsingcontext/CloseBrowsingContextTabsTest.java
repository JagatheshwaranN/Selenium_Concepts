...
public class CloseBrowsingContextTabsTest {
    ...
    @Test(priority = 1)
    public void testCloseBrowsingContextTabs() {
        // Create the first BrowsingContext instance using the current WebDriver instance and a new window type as TAB
        BrowsingContext browsingContext1 = new BrowsingContext(driver, WindowType.TAB);

        // Create the second BrowsingContext instance using the current WebDriver instance and a new window type as TAB
